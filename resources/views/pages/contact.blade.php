...
<section class="page-hero">
    <div class="container">
        ...
        <p>Contact the church or send a prayer request.</p>
    </div>
</section>
...
<section class="section">
    <div class="container contact-page-grid">
        <div>
            ...
            <div class="contact-card-list">
                <article>
                    ...
                    <p>Valley Road, Canaansite Estate, Nakwero Gayaza</p>
                </article>

                <article>
                    <strong>Telephone</strong>
                    <p>
                        <a href="tel:+256774328127">+256 774 328 127</a><br>
                ...
                <article>
                    ...
                    <div class="contact-social-icons" aria-label="Church social media links">
                        <a class="contact-social-icon facebook" href="https://www.facebook.com/profile.php?id=100071484482919" target="_blank" rel="noopener" aria-label="Facebook">
                        ...
                        <a class="contact-social-icon instagram" href="https://www.instagram.com/revelationhourm?igsh=MXA2bTl6YWRhYjA3eg==" target="_blank" rel="noopener" aria-label="Instagram">
                        ...
                        <a class="contact-social-icon telegram" href="https://t.me/revelationhourministriesintl" target="_blank" rel="noopener" aria-label="Telegram">
                        ...
                        <a class="contact-social-icon whatsapp" href="https://whatsapp.com/channel/0029VaI0L5MKrWR3io0kPv3k" target="_blank" rel="noopener" aria-label="WhatsApp">
                        ...
                        <a class="contact-social-icon x-social" href="https://x.com/i/status/2076041680076320771" target="_blank" rel="noopener" aria-label="X">
                        ...
                        <a class="contact-social-icon youtube" href="https://youtube.com/@revelationhourm?si=gyH5QweTg4264hK-" target="_blank" rel="noopener" aria-label="YouTube">
                        ...
                        <a class="contact-social-icon tiktok" href="https://www.tiktok.com/@revelationhourm?_r=1&_t=ZS-97O8lEN8aQ6" target="_blank" rel="noopener" aria-label="TikTok">
        ...
        <form class="public-form" onsubmit="event.preventDefault();">
            <h2>Send a message or prayer request</h2>
            <p>This form will connect to the private CMS Prayer Requests module.</p>
